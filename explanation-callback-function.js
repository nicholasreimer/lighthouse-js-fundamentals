...
-when we go to the function helloCat it has a temporary placeholder value of callbackfunc as its arguement 
(callbackfunc is the placeholder for catSays func)

when the function is run it will add the string "hello " to the output of the callbackfunc with 3 as its arguement
-now we jump to the cat says function on line 1 where we encounter a function that uses the callbackfunc arguement of 3 
as the arguement for a parameter called 'max"
